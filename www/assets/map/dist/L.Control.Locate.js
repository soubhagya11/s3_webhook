...
(function (factory, window) {
    ...
    var LocateControl = L.Control.extend({
        options: {
            ...
            icon: 'icon asset-icon-current-position current-position',
            iconLoading: 'loader',
            ...
            createButtonCallback: function (container, options) {
                var link = L.DomUtil.create('a', 'current-location leaflet-bar-part leaflet-bar-part-single', container);
                link.title = options.strings.title;
                var icon = L.DomUtil.create(options.iconElementTag, options.icon, link);
                var title = L.DomUtil.create('span', 'loc-text', container);
                title.innerHTML = 'Locate';
        ...
        /**
         * This method is added to continously toggle location button - 210528.
         */
        _onClick: function() {
