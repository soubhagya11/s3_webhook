...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		textErr: mapNamesObj.location_not_found,	//error message
		textCancel: mapNamesObj.cancel,		    //title in cancel button		
		textPlaceholder: mapNamesObj.search + '...',   //placeholder value			
	...
	onAdd: function (map) {
		this._map = map;
		this._container = L.DomUtil.create('div', 'leaflet-control-search lftspace');
		this._input = this._createInput(this.options.textPlaceholder, 'search-input ptext');
		this._tooltip = this._createTooltip('search-tooltip');
		this._cancel = this._createCancel(this.options.textCancel, 'search-cancel');
		this._button = this._createButton(this.options.textPlaceholder, 'search-button pmap');
		this._alert = this._createAlert('search-alert');
		var aa = localStorage.getItem('device');
if( aa === 'false'){
