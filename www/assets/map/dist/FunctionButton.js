 ...
 * Modified by Sreenadh@Pigeon-Tech
 */
"use strict";
L.FunctionButtons = L.Control.extend({
	...
	highlightButton: function(index) {
		//added by Sreenadh to highlight the button when floor is changed during multifloor navigation
		...
		this._buttons[this.selectedButtonIndex].link.style.color=this._buttons[this.selectedButtonIndex].fontColor;
		this._buttons[this.selectedButtonIndex].link.style.fontWeight='normal';
		button.link.style.backgroundColor=button.highColor;
		button.link.style.color=button.color;
		button.link.style.fontWeight = 'bold';
